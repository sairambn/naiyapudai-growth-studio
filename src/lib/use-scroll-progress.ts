...
/**
 * Imperative scroll binder: applies transform/opacity via DOM each frame.
 * Zero React re-renders for the animated layers.
 */
export function useScrollLayers<T extends HTMLElement = HTMLElement>(options?: {
  lerp?: number;
}) {
